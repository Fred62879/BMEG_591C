...
%     subplot(1,3,1);imagesc( imadjust(mat2gray(abs(avgOCTA_sub(:,:,1))))); colormap(gray);
%     subplot(1,3,2);imagesc( imadjust(mat2gray(abs(avgOCTA_var(:,:,1))))); colormap(gray);
%     subplot(1,3,3);imagesc( imadjust(mat2gray(abs(avgOCTA_dec(:,:,1))))); colormap(gray);
% 
%     for i = 1:num_frames
